	...
	return (
		<div className="flex flex-col gap-10 h-full pr-5">
			...
			<div className="flex flex-col">
				...
				<div className="font-bold text-6xl underline">
					{workout.name.toUpperCase()}
				</div>
			</div>
			<div className="flex flex-col gap-2">
				<span className="font-bold text-2xl">
					<span className="text-5xl font-black underline">
				...
				<span className="font-bold text-2xl">
					<span className="text-5xl font-black underline">
						{aggregateMuscles(workout).length}
					</span>{" "}
			...
			<div className="flex flex-col gap-2">
				...
				<span className="text-lg w-[20rem]">
					{quote.getRandomQuote() as string}
				</span>
			</div>
		</div>
	);
